...
#if XENKO_INPUT_RAWINPUT || (XENKO_UI_WINFORMS || XENKO_UI_WPF)
...
#pragma warning restore SA1310 // Field names should not contain underscore
        ...
        private static Dictionary<WinFormsKeys, Keys> NewMapKeys()
        {
            ...
            map[WinFormsKeys.OemSemicolon] = Keys.Semicolon;
            map[WinFormsKeys.Oemplus] = Keys.Plus;
            map[WinFormsKeys.Oemcomma] = Keys.Comma;
            map[WinFormsKeys.OemMinus] = Keys.Minus;
            map[WinFormsKeys.OemPeriod] = Keys.Period;
            //map[WinFormsKeys.Oem2] = Keys.Oem2;
            map[WinFormsKeys.OemQuestion] = Keys.Question;
            //map[WinFormsKeys.Oem3] = Keys.Oem3;
            map[WinFormsKeys.Oemtilde] = Keys.Tilde;
            //map[WinFormsKeys.Oem4] = Keys.Oem4;
            map[WinFormsKeys.OemOpenBrackets] = Keys.OpenBrackets;
            //map[WinFormsKeys.Oem5] = Keys.Oem5;
            map[WinFormsKeys.OemPipe] = Keys.Pipe;
            //map[WinFormsKeys.Oem6] = Keys.Oem6;
            map[WinFormsKeys.OemCloseBrackets] = Keys.CloseBrackets;
            //map[WinFormsKeys.Oem7] = Keys.Oem7;
            map[WinFormsKeys.OemQuotes] = Keys.Quotes;
            //map[WinFormsKeys.Oem8] = Keys.Oem8;
            //map[WinFormsKeys.Oem102] = Keys.Oem102;
            map[WinFormsKeys.OemBackslash] = Keys.Backslash;
