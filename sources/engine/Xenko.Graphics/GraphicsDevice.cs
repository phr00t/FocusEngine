...
namespace Xenko.Graphics
{
    ...
    public partial class GraphicsDevice : ComponentBase
    {
        ...
        public void Recreate(GraphicsAdapter adapter, GraphicsProfile[] profile, DeviceCreationFlags deviceCreationFlags, WindowHandle windowHandle)
        {
            ...
            Adapter = adapter;
            IsDebugMode = deviceCreationFlags == DeviceCreationFlags.Debug || deviceCreationFlags == DeviceCreationFlags.DebugAndBreak || deviceCreationFlags == DeviceCreationFlags.DebugAndBreakUnique;
