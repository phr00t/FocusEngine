    ...
    public class AudioSystem : GameSystemBase, IAudioEngineProvider
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (tc != null && listener != null)
            {
                ...
                listener.Velocity = GlobalSoundManager.CompletelyDisableDopplerEffect ? Vector3.Zero : (newPosition - listener.Position) / (float)gameTime.TimePerFrame.TotalSeconds; // estimate velocity from last and new position
