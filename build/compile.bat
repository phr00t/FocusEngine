...
:compile
set _option=/nologo /nr:false /m /verbosity:%__BuildVerbosity% /p:Configuration=%__BuildType% /p:Platform="%_platform_target%" /p:XenkoSkipUnitTests=%__SkipTestBuild% %Project% /p:DeployExtension=false
